...
\newpage
    ...
    \subsection{Integration testing}
        Integration tests are also run using jest. In these tests, the modules tested in unit testing phase are integrated, and tested together.
        \\
        The formatting of the tables will be the same as in unit testing. 
        \subsubsection{Test cases}  
